...
function SuccessfulProjects() {
  const projectCard = [
    ...
    },
    {
      ...
      img: "https://zarqsolution.com/wp-content/uploads/2025/03/screencapture-hawk-sports-de-en-hawk-sports-an-online-sports-shop-2025-03-09-11_31_52.webp",
      link: "https://zarqsolution.com/shipcl/",
    },
    {
      id: 8,
      ...
      img: "https://zarqsolution.com/wp-content/uploads/2025/04/Group-47334.png",
      link: "https://zarqsolution.com/shipcl/",
    },
  ];
    ...
    <section className="bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          <h2 className="text-3xl  font-[1000] text-[#0B80DA]  mb-2">
