    ...
    <div className="overflow-x-hidden">
      ...
      <section className="relative flex items-center justify-center min-h-[80vh] w-full overflow-hidden px-3 sm:px-6 lg:px-12">
        ...
        <div
          ...
          style={{
            backgroundImage: `linear-gradient(rgba(0,0,40,0.7), rgba(0,0,50,0.7)), url(${webDev})`,
        ...
        <div className="relative z-10 text-center flex flex-col items-center justify-center space-y-6 max-w-3xl w-full pt-12">
          ...
          <p
            ...
            data-aos-delay="100"
          >
            Building lightning fast, user-centric websites that don’t just look
            great they convert. We craft high-performance digital experiences
            optimized for speed, usability, and business growth.
          </p>
        </div>
      </section>
